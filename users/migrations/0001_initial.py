    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_course', models.ForeignKey(blank=True, help_text='Course this session template belongs to', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='template_sessions', to='users.course')),
